...
namespace ClassicGarageAuth.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private GarageContext garageContext = new GarageContext();
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var owner = new OwnerModel { FirstName = model.FirstName, LastName = model.LastName, PhoneNumber = model.PhoneNumber, Email = model.Email };
                    owner.UserID = user.Id;

                    garageContext.OwnerModels.Add(owner);
