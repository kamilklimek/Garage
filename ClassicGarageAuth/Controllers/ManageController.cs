...
namespace ClassicGarageAuth.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        private DAL.GarageContext garageContext = new DAL.GarageContext();
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var ownerModels = garageContext.OwnerModels.ToList();
            var foundModel = ownerModels.Where(owner => owner.UserID == userId).Single();
